  ...
  return (
    <main className="flex flex-col items-center gap-9 px-4 md:px-20  py-12 bombay-bg-color cold-gray-color">
      <div className="text-center">
        <LottieSearch />
        <h1 className="mb-6 -mt-2 text-3xl md:text-4xl lg:text-5xl font-extrabold leading-none tracking-tight text-gray-900">
          Elevate Your Economic Research
        </h1>

        <p className="mb-6 text-base md:text-lg lg:text-xl font-normal text-gray-500 px-4 lg:px-0">
          Use a  seamless filtering that allows you to focus on
          the most pertinent articles within economic journals.{" "}
        </p>
      </div>
